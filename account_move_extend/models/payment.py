...
class CustomRegisterPayment(models.TransientModel):
    ...
    line_ids = fields.Many2many('account.move.line', 'custom_payment_register_move_line_rel', 'wizard_id', 'line_id',
    ...
    def _create_payments(self):
        ...
        payments = self.env[model].create(payment_vals_list)
        ...
        payments.button_done() if entity == 'supplier' else payments.action_caisse()

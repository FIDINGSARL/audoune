...
class PaiementPesClient(models.Model):
    _name = 'paiement.pec.client'
    _inherit = ['mail.thread', 'mail.activity.mixin']

    _description = 'Prise en charge Client'
    _order = "date desc"
    ...
    def unlink(self):
        for rec in self:
            ...
            move_ids.unlink()
        return super(PaiementPesClient, self).unlink()
    ...
    def copy(self, default=None):
        ...
        return super(PaiementPesClient, self).copy(default)
    ...
    def action_post_entries(self):
        ...
        for pec in self:
            ...
            credit_val = {
                ...
                'ref': pec.note,
                'partner_id': pec.client.id,
                'account_id': pec.journal_id.default_account_id.id,
                'credit': 0.0,
                'debit': pec.amount,
                'pec_client_id': pec.id,
                'journal_id': pec.journal_id.id,
